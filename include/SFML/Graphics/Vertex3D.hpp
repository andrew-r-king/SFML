...
#ifndef SFML_VERTEX_3D_HPP
#define SFML_VERTEX_3D_HPP
...
///
////////////////////////////////////////////////////////////
class SFML_GRAPHICS_API Vertex3D
{
public:
    ...
    ///
    ////////////////////////////////////////////////////////////
    Vertex3D(const Vector3f& thePosition);
    ...
    ///
    ////////////////////////////////////////////////////////////
    Vertex3D(const Vector3f& thePosition, const Color& theColor);
    ...
    ///
    ////////////////////////////////////////////////////////////
    Vertex3D(const Vector3f& thePosition, const Vector2f& theTexCoords);
    ...
    ///
    ////////////////////////////////////////////////////////////
    Vertex3D(const Vector3f& thePosition, const Color& theColor, const Vector2f& theTexCoords);
...
/// as 3D primitives (triangles, quads, ...), and these primitives
/// are grouped to create even more complex 3D entities such as
/// sprites, texts, etc.
///
/// If you use the graphical entities of SFML (sprite, text, shape)
/// you won't have to deal with vertices directly. But if you want
/// to define your own 3D entities, such as tiled maps or particle
...
/// sf::Vertex vertices[] =
/// {
///     sf::Vertex(sf::Vector3f(  0,   0), sf::Colors::Red, sf::Vector3f( 0,  0)),
///     sf::Vertex(sf::Vector3f(  0, 100), sf::Colors::Red, sf::Vector3f( 0, 10)),
///     sf::Vertex(sf::Vector3f(100, 100), sf::Colors::Red, sf::Vector3f(10, 10)),
///     sf::Vertex(sf::Vector3f(100,   0), sf::Colors::Red, sf::Vector3f(10,  0))
/// };
///
/// // draw it
